  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-6 md:py-8 pb-28 md:pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
        ...
        {/* ── Product Details ── */}
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-[#1a1a1a] mb-2">
            {product.name}
          </h1>
          {product.variant && (
            <p className="text-sm md:text-base text-gray-500 mb-3">{product.variant}</p>
          )}
          ...
          <p className="text-sm mb-5 md:mb-6">
            {inStock ? (
          ...
          <p className="text-sm md:text-base text-gray-600 mb-5 md:mb-6 max-w-md leading-relaxed">
            {product.description ||
